...
namespace Practice
{
    ...
    class Code
    {
        ...
        static public void Add_Teacher()
        {
            ...
            teachers.Add(new Teacherdata { Id = tid, Name = tname, Sub = tsub, Section = tloc });
        ...
        static public void Update_Teacher()
        {
            ...
            foreach (var item in update)
            {
                if (item.StartsWith(tupdate))
                {
                    ...
                    Console.WriteLine($"Enter the Section");
                    string tloc = Console.ReadLine();
                    teachers.Add(new Teacherdata { Id = Convert.ToInt32(tupdate), Name = name, Sub = sub, Section = tloc });
